          ...
          <form onSubmit={onSubmit} className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                disabled={isLoading}
                required
                className="bg-input text-foreground border-border placeholder:text-muted-foreground focus:border-ring focus:ring-ring"
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="absolute right-2 top-1/2 -translate-y-1/2 hover:bg-accent text-muted-foreground"
